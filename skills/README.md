...
| `design-to-code-pipeline` | combo | Combo workflow: Figma design → tokens → shadcn/Relume components → Framer or app code, with the fusion-harness fanning out builders |
...
| `ship-and-verify` | combo | Combo workflow: gate a build with TestMu cloud runs, Kane CLI browser flows, and Momentic E2E before merge, wired into /fh-auto-validate |
